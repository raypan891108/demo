...
public class bookController {
    ...
    public ResponseEntity updateEmployee(@PathVariable Integer id, @RequestBody BookFromRequest updateBook, HttpServletRequest request) {
...
//    public ResponseEntity<List<Author>> getAllAuthorByBookId(@PathVariable("id") Integer bookId,
//                                                             HttpServletRequest request){
//        return bks.getAllAuthorByBookId(bookId, request);
//    }
